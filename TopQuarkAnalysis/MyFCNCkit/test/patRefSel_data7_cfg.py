...
# Step 0
#triggerSelectionData = 'HLT_DoubleEle* && HLT_DoubleMu*'
#triggerSelectionMC   = 'HLT_DoubleEle* && HLT_DoubleMu*'
triggerSelectionData = 'HLT_Double*'
triggerSelectionMC   = 'HLT_Double*'
...
MessageLogger.cerr.FwkReport.reportEvery = fwkReportEvery
...
#process.metFilters = metFilters.clone()
...
#process.eventCleaningMiniAOD = metFilters #cms.Sequence(
...
process.goodOfflinePrimaryVertices = process.goodVertices.clone( filter = True )
