...
const int nFiles=23; //matrix weight but number is 0 to 16
//const int nFiles=22; //matrix weight but number is 0 to 16

std::string Labels[nFiles+1]=
  {
...
//    "sig_TTbWcZ_3LPY8_aaa.root",  // T2CZ
    "sig_TTbWcZ_3LPY8_K_Zct.root",  // T2CZ
    "ttbarll_TTbWcZ_3LPY8.root",     // ttjets
    "tth_TTbWcZ_3LPY8.root",     // tthiggs
    ...
    "wz2l2q_TTbWcZ_3LPY8.root",   // wz2l2q
    ...
    "sig_TTbWcZ_3LPY8_10.root", // tb_s
    "st-t_TTbWcZ_3LPY8.root", // t_t
    "sig_TTbWcZ_3LPY8_10.root ", // tb_t
    "st-tW_TTbWcZ_3LPY8.root",   // t_tw
    "sig_TTbWcZ_3LPY8_10.root",    // tb_tw
...
double hist_scale[nFiles] = 
  {
    2*0.0005*831.76*0.10099*0.324 *INT_LUM/TcZ,       // T2HC  0.10099 Z->ll; 0.324 W->lepton and tau; FCNC 0.1%
    831.76*0.324*0.324            *INT_LUM/ttjets,     // ttjets
    0.5085          *INT_LUM/tthiggs,     // tthiggs   
    ...
    0*3.36            *INT_LUM/tb_s,       // tb_s
    44.33           *INT_LUM/t_t,        // t_t
    0*26.38           *INT_LUM/tb_t,       // tb_t
    35.85           *INT_LUM/t_tw,       // t_tw
    0*35.85           *INT_LUM/tb_tw       // tb_tw
};
